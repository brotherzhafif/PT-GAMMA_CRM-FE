        ...
        <div className="w-full lg:w-80 space-y-6">
          <Card className="p-6 shadow-sm border-none bg-white">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button variant="ghost" className="cursor-pointer text-emerald-500 text-sm font-bold">
                Settings
              </Button>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-orange-50/50 rounded-xl border border-orange-100 relative overflow-hidden">
                ...
                <p className="text-lg font-bold text-slate-800">
                  Rp 100.000 = 10 Points
                </p>
                <p className="text-[11px] text-slate-400 mt-2 leading-relaxed">
                  Patients earn points for every completed visit based on
                  invoice total.
                </p>
              </div>
